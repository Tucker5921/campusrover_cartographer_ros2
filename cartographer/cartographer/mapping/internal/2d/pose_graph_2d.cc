...
void PoseGraph2D::DeleteTrajectoriesIfNeeded() {
  ...
  std::cout<<"DeleteTrajectoriesIfNeeded : pose_graph_2d.cc"<<std::endl;
}
...
void PoseGraph2D::DeleteTrajectory(const int trajectory_id) {
  common::MutexLocker locker(&mutex_);
  std::cout<<"DeleteTrajectory : pose_graph_2d.cc"<<std::endl;
...
void PoseGraph2D::FinishTrajectory(const int trajectory_id) {
  common::MutexLocker locker(&mutex_);
  std::cout<<"AddTrajectory : pose_graph_2d.cc"<<std::endl;
  AddWorkItem([this, trajectory_id]() REQUIRES(mutex_) {
